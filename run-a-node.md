...
4. get the ignite cli `curl https://get.ignite.com/cli! | sudo bash` (check out their site: https://docs.ignite.com/)
5. check that ignite works `ignite version` - should produce output like
